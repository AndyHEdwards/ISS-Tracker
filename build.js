System.registerDynamic("npm:whatwg-fetch@0.10.1/fetch", [], true, function($__require, exports, module) {
  ;
  var global = this,
...
System.registerDynamic("npm:whatwg-fetch@0.10.1", ["npm:whatwg-fetch@0.10.1/fetch"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = $__require('npm:whatwg-fetch@0.10.1/fetch');
  global.define = __define;
  return module.exports;
});
...
System.register('app/Map.js', ['npm:react@0.14.3', 'app/api.js'], function (_export) {
  'use strict';
  ...
  return {
    setters: [function (_npmReact0143) {
      ...
      issLocation = _appApiJs.issLocation;
    }],
    execute: function () {
...
System.register('app/main.js', ['npm:react@0.14.3', 'npm:react-dom@0.14.3', 'app/Map.js', 'npm:whatwg-fetch@0.10.1', 'app/api.js'], function (_export) {
  'use strict';

  var React, ReactDOM, Map, issLocation;
  return {
    setters: [function (_npmReact0143) {
      React = _npmReact0143['default'];
      ...
      Map = _appMapJs['default'];
    }, function (_npmWhatwgFetch0101) {}, function (_appApiJs) {
      issLocation = _appApiJs.issLocation;
    }],
    execute: function () {
